...
import "./Header.css";
import CircleNum from '../CircleNum/CircleNum';
...
function Header() {
  ...
  useEffect(() => {
    ...
    if (CartNumber) {
      setCountProducts(Object.keys(CartNumber).length);
    }
  }, [setCountProducts]);
  return (
    <div className="container mb-3">
      <header className="row pt-2 pb-2">
        <div className="col-8 headtext ms-5"><Link to="/" style={{ textDecoration: 'none', color: 'black' }}>QPICK</Link></div>
        <div className="col-3 d-flex justify-content-end">
          <div className="likeIcon me-4 align-self-center">
          ...
          <div className="basketBlock align-self-center me-4">
            <div className="part basketIcon">
            ...
            <div className="part numProd"><CircleNum text={countProducts}/></div>
          </div>
        </div>
      </header>
    </div>
